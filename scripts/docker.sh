...
docker build -t suxiaoshao/graphql:0.0.7 -f ./docker/graphql.Dockerfile .;
docker push suxiaoshao/graphql:0.0.7;

docker build -t suxiaoshao/auth:0.0.6 -f ./docker/auth.Dockerfile .;
docker push suxiaoshao/auth:0.0.6;
